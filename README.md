...
```
cd existing_repo
git remote add origin https://gitlab.msu.edu/thammina/angrysparty.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.msu.edu/thammina/angrysparty/-/settings/integrations)
